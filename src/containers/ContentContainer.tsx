...
export default function ContentContainer() {
    ...
    // usare Note per i successivi hook
    ...
    //seguenti da eliminare totalmente. usare {notes} in qualche modo */
    ...
    */
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            ...
            const response: Response = await fetch("/il-secondo-semestre/");
            ...
            for (let i = 0; i < scraped.length; i++) {
                let str: string = scraped[i].outerText;

                let id: number = str.split("-")[1].split(".")[0];
                let subject: string = str.split("-")[0];
